<template>
  <div id='sell2'>
    <sub-title title="汽车销售" :link="[{name:'在线商务',to: ''},{name:'汽车销售',to:''}]"></sub-title>
    <div class="content">
      <div class="examine">
        ...
        <p style="text-align: center;">
          <span style="font-size: 16px;">&nbsp;&nbsp;<img src="http://static.shanghaiqixiu.org/images/2017/10/28/pic_1511873612808.png" title="" alt="demo.jpg"></span>
        </p>
        <p>
        ...
        <p style="text-align: center;">
          <span style="font-family: 微软雅黑, &quot;Microsoft YaHei&quot;; font-size: 16px;"><img src="http://static.shanghaiqixiu.org/images/2017/10/28/pic_1511873646110.png" title="" alt="demo.jpg"></span>
        </p>
        <p style="text-align: center;">
          <span style="font-family: 微软雅黑, &quot;Microsoft YaHei&quot;; font-size: 16px;"><img src="http://static.shanghaiqixiu.org/images/2017/10/28/pic_1511873680764.png" title="" alt="demo.jpg" style='width: 100%'></span>
        </p>
        <p style="text-align: center;">
          <span style="font-family: 微软雅黑, &quot;Microsoft YaHei&quot;; font-size: 16px;"><img src="http://static.shanghaiqixiu.org/images/2017/10/28/pic_1511873698559.png" title="" alt="demo.jpg">&nbsp;</span>
        </p>
        <p style="text-align: center;">
          <br>
        </p>
